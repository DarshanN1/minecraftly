...
Check out [GETTING-STARTED.md](https://github.com/Minecraftly/Minecraftly/blob/master/GETTING-STARTED.md) for more information about setting up the development environment for Cuberite, finding issues to work on, etc...
